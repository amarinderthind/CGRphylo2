...
CGRphylo2 provides an alignment-free phylogenetic analysis method
    ...
    formats (MEGA, PHYLIP, Newick). Earlier version refernce is Thind and Sinha (2023)
...
# Read FASTA file
fastafile <- seqinr::read.fasta("example_sequences.fasta",
  seqtype = "DNA",
  as.string = TRUE,
...
N_filter <- 50 #based on 30k bases genome
